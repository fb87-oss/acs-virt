...
- `x64`: builds `out/qemu-x64-minimal/bin/qemu-system-x86_64` using `cmake/qemu-targets/x64-minimal.cmake`.
- `a64` or `arm64`: builds `out/qemu-arm64-default/bin/qemu-system-aarch64` using `cmake/qemu-targets/arm64-default.cmake`.
